    ...
    <div class="row g-3 mb-4">
        <div class="col-12">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <h2 class="mb-1">
                        <i class="bi bi-lock-fill me-2" style="font-size: 1.5rem;"></i>Hak Akses (Permissions)
                    </h2>
                    <p class="text-muted small mb-0">Kelola hak akses sistem</p>
                </div>
        ...
        <div class="hris-card-body p-0">
            ...
            @else
                <div class="text-center py-5">
                    <i class="bi bi-lock" style="font-size: 3rem; color: var(--hris-border);"></i>
                    <div class="text-muted mt-3">Belum ada data permission</div>
                    <a href="{{ route('admin.permissions.create') }}" class="btn btn-primary mt-3">
                        <i class="bi bi-plus-circle me-2"></i>Tambah Permission Pertama
                    </a>
                </div>
            @endif
        </div>

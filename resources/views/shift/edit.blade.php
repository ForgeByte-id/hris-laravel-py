        ...
        <div class="col-lg-7">
            <div class="hris-card">
                <div class="hris-card-header d-flex align-items-center justify-content-between">
                    <h2 class="mb-0"><i class="bi bi-pencil-fill me-2"></i>Edit Shift</h2>
                    ...
                    <form action="{{ route('shift.update', $shift->id_shift) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kode_shift"
                                   ...
                                   value="{{ old('kode_shift', $shift->kode_shift) }}" maxlength="2" required>
                            @error('kode_shift')
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="time" name="jam_masuk"
                                       ...
                                       value="{{ old('jam_masuk', $shift->jam_masuk ? substr($shift->jam_masuk, 0, 5) : '') }}">
                                @error('jam_masuk')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="time" name="jam_pulang"
                                       ...
                                       value="{{ old('jam_pulang', $shift->jam_pulang ? substr($shift->jam_pulang, 0, 5) : '') }}">
                                @error('jam_pulang')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
